...
* `org.lightsleep.database.Database<ST, DT>## #interface`
    * `<E> String selectSql(Sql<E> sql, List<Object> parameters)`  
    → `<E># [small red]#CharSequence selectSql(Sql<E> sql, List<Object> parameters)`
    * `<E> String subSelectSql(Sql<E> sql, List<Object> parameters)`  
    → `<E,# [small red]#OE> CharSequence subSelectSql(Sql<E> sql,## [small red]#Sql<OE> outerSql,# List<Object> parameters)`
    * `<E> String subSelectSql(Sql<E> sql, Supplier<CharSequence> columnsSupplier, List<Object> parameters)`  
    → `<E,# [small red]#OE> CharSequence subSelectSql(Sql<E> sql,## [small red]#Sql<OE> outerSql,# Supplier<CharSequence> columnsSupplier, List<Object> parameters)`
    * `<E> String insertSql(Sql<E> sql, List<Object> parameters)`  
    → `<E># [small red]#CharSequence insertSql(Sql<E> sql, List<Object> parameters)`
    * `<E> String updateSql(Sql<E> sql, List<Object> parameters)`  
    → `<E># [small red]#CharSequence updateSql(Sql<E> sql, List<Object> parameters)`
