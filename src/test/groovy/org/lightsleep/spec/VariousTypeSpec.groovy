...
// VariousTypeSpec
@Unroll
class VariousTypeSpec extends Base {
    def setup() {
        deleteAllTables()
    }

    def "VariousTypeSpec various types"() {
        ...
        DebugTrace.print("various2", various2);
    ...
    def "VariousTypeSpec number types"() {
        DebugTrace.enter() // for Debugging
    ...
    def "VariousTypeSpec string type"() {
        DebugTrace.enter() // for Debugging
